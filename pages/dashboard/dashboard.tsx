...
const navigation = [
  ...
  { name: "Comunidad", href: "https://discord.gg/d6Bp55mY", icon: UsersIcon, current: false },
  {
...
const teams = [
  { id: 1, name: "Chat GPT", href: "/dashboard/chatgpt", initial: "C", current: false },
  { id: 2, name: "Wallets Digitales", href: "#", initial: "W", current: false },
  { id: 3, name: "Comunidad", href: "https://discord.gg/d6Bp55mY", initial: "C", current: false },
];
